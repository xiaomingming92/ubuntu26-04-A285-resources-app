...
- **文件**: [src/lib/auth.ts:3](file:///home/xmm/ai/resources/src/lib/auth.ts#L3)
- **状态**: 仍存在
...
- **文件**: [src/lib/farm-server-client.ts:74-76](file:///home/xmm/ai/resources/src/lib/farm-server-client.ts#L74-L76)
- **状态**: 仍存在
...
- **文件**: [src/lib/llm.ts](file:///home/xmm/ai/resources/src/lib/llm.ts) / [src/lib/llm/index.ts](file:///home/xmm/ai/resources/src/lib/llm/index.ts)
- **状态**: 仍存在
...
- **文件**: [src/lib/chroma.ts](file:///home/xmm/ai/resources/src/lib/chroma.ts) / [src/lib/chroma-client.ts](file:///home/xmm/ai/resources/src/lib/chroma-client.ts)
- **状态**: 仍存在
...
- **文件**: [src/lib/auth.ts:27](file:///home/xmm/ai/resources/src/lib/auth.ts#L27) / [src/caijuehub/strategies/auth-gateway.ts:59](file:///home/xmm/ai/resources/src/caijuehub/strategies/auth-gateway.ts#L59)
- **状态**: 仍存在
...
- **文件**: [src/lib/agent-gateway-dev-logger.ts:12](file:///home/xmm/ai/resources/src/lib/agent-gateway-dev-logger.ts#L12) / [src/lib/agent-gateway-audit.ts](file:///home/xmm/ai/resources/src/lib/agent-gateway-audit.ts)
- **状态**: 仍存在
...
- **文件**: [src/services/audit-log.ts:30](file:///home/xmm/ai/resources/src/services/audit-log.ts#L30)
- **状态**: 仍存在
...
- **文件**: [src/agents/index.ts](file:///home/xmm/ai/resources/src/agents/index.ts)
- **状态**: 仍存在
...
- **文件**: [src/lib/llm/index.ts:215-248](file:///home/xmm/ai/resources/src/lib/llm/index.ts#L215-L248)
- **状态**: 仍存在
...
- **文件**: [src/agents/index.ts:239](file:///home/xmm/ai/resources/src/agents/index.ts#L239)
- **状态**: 仍存在
...
- **文件**: [src/lib/agent-audit-logger.ts:175-180](file:///home/xmm/ai/resources/src/lib/agent-audit-logger.ts#L175-L180)
- **状态**: 仍存在
...
- **文件**: [src/app/api/agent/chat/route.ts:17](file:///home/xmm/ai/resources/src/app/api/agent/chat/route.ts#L17)
- **状态**: 仍存在
...
- **文件**: [src/lib/llm/index.ts:246-247](file:///home/xmm/ai/resources/src/lib/llm/index.ts#L246-L247)
- **状态**: 仍存在
...
- **文件**: [src/agents/index.ts](file:///home/xmm/ai/resources/src/agents/index.ts) 等多处
...
- **文件**: [src/services/knowledge-indexer.ts:568-586](file:///home/xmm/ai/resources/src/services/knowledge-indexer.ts#L568-L586)
- **状态**: 仍存在
...
- **文件**: [src/agents/policy-update-loop.ts:149](file:///home/xmm/ai/resources/src/agents/policy-update-loop.ts#L149)
- **状态**: 仍存在
...
- **文件**: [src/lib/agent-audit-logger.ts:15-143](file:///home/xmm/ai/resources/src/lib/agent-audit-logger.ts#L15-L143)
- **状态**: 仍存在
...
- **文件**: [prisma/schema.prisma:12-14](file:///home/xmm/ai/resources/prisma/schema.prisma#L12-L14)
- **状态**: 仍存在
...
- **文件**: [docker-compose.yml:50](file:///home/xmm/ai/resources/docker-compose.yml#L50)
- **状态**: 仍存在
...
- **文件**: [docker-compose.yml:30-36](file:///home/xmm/ai/resources/docker-compose.yml#L30-L36) / [docker-compose.yml:60-67](file:///home/xmm/ai/resources/docker-compose.yml#L60-L67)
- **状态**: 仍存在
...
| # | 问题 | 文件 | 严重度 |
|---|------|------|--------|
| 25 | `extractTokenFromRequest` 重复定义 | [auth.ts](file:///home/xmm/ai/resources/src/lib/auth.ts#L27) / [auth-gateway.ts](file:///home/xmm/ai/resources/src/caijuehub/strategies/auth-gateway.ts#L59) | 中 |
| 26 | Chroma 客户端双实现 | [chroma.ts](file:///home/xmm/ai/resources/src/lib/chroma.ts) / [chroma-client.ts](file:///home/xmm/ai/resources/src/lib/chroma-client.ts) | 中 |
| 27 | 日志模块行为不一致 | [agent-gateway-dev-logger.ts](file:///home/xmm/ai/resources/src/lib/agent-gateway-dev-logger.ts) vs [agent-gateway-audit.ts](file:///home/xmm/ai/resources/src/lib/agent-gateway-audit.ts) | 中 |
| 28 | 审计日志内存存储 vs DB 持久化不一致 | [audit-log.ts](file:///home/xmm/ai/resources/src/services/audit-log.ts) | 中 |
| 29 | `AgentAuditPhase` 类型 80+ 联合成员 | [agent-audit-logger.ts](file:///home/xmm/ai/resources/src/lib/agent-audit-logger.ts) | 低 |
| 30 | `knowledge-indexer.ts` RAG-DEBUG 日志遗留 | [knowledge-indexer.ts](file:///home/xmm/ai/resources/src/services/knowledge-indexer.ts) | 低 |
| 31 | 未完成 TODO | [policy-update-loop.ts](file:///home/xmm/ai/resources/src/agents/policy-update-loop.ts) | 低 |
