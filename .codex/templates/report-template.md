...
- **分类**: 安全风险
- **状态**: ❌ 仍存在
- **运行时网关关联**: `resources-runtime-report/gateway.md#L{line}` (Gateway 运行时发现 {n} 次)
...
|-------|-----------|---------|:----:|------------|
| {ID} | `resources-runtime-report/gateway.md` | {ts} | {n} | 确认为 Bug → P1 |
| {ID} | `resources-runtime-report/gateway.md` | {ts} | {n} | 环境问题 → 关闭 |
