...
- 具体实现细节以对应 `.codex/specs/{spec-name}/spec.md`、`tasks.md`、`checklist.md` 为准。
...
4. read ".codex/specs/{spec-name}/spec.md"
5. read ".codex/specs/{spec-name}/tasks.md"
6. read ".codex/specs/{spec-name}/checklist.md"
```
...
- `.codex/specs/{spec-name}/spec.md`
- `.codex/specs/{spec-name}/tasks.md`
- `.codex/specs/{spec-name}/checklist.md`
...
3. 读本轮对应 .codex/specs/{spec-name}/spec.md（含其中的「文档先行三步闭环」章节，按 spec 的指示更新架构文档）
4. 读本轮对应 .codex/specs/{spec-name}/tasks.md
5. 读本轮对应 .codex/specs/{spec-name}/checklist.md
